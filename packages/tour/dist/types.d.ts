...
export declare type TourProps = SharedProps & ClickProps & {
    isOpen: Boolean;
...
export declare type ProviderProps = SharedProps & {
...
export declare type BtnFnProps = {
