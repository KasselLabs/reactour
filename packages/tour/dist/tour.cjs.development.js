...
var utils = require('@reactour/utils');
var mask = require('@reactour/mask');
var popover = require('@reactour/popover');
...
function useSizes(step, scrollOptions) {
  ...
  var _useState4 = React.useState(initialState),
  ...
  React.useEffect(function () {
    var isInView = utils.inView(_extends({}, dimensions, {
    ...
    if (!isInView && target) {
      setTransition(true);
      utils.smoothScroll(target, scrollOptions).then(function () {
...
function getHighlightedRect(node, highlightedSelectors, bypassElem) {
  ...
  var _getWindow = utils.getWindow(),
      windowWidth = _getWindow.w,
      windowHeight = _getWindow.h;

  if (!highlightedSelectors) {
    return _extends({}, utils.getRect(node), {
      windowWidth: windowWidth,
      windowHeight: windowHeight
    });
  }

  var attrs = utils.getRect(node);
  var altAttrs = {
    bottom: 0,
    height: 0,
    left: windowWidth,
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(highlightedSelectors), _step; !(_step = _iterator()).done;) {
    ...
    var rect = utils.getRect(element);
...
var Close = function Close(_ref) {
  ...
  var getStyles = stylesMatcher(styles);
  return react.jsx("button", Object.assign({
...
var Tour = function Tour(_ref) {
  ...
  return step ? React__default.createElement(utils.Portal, null, React__default.createElement(FocusManager, {
    disabled: disableFocusLock
  }, React__default.createElement(utils.Observables, {
  ...
  }), React__default.createElement(Keyboard, {
    setCurrentStep: setCurrentStep,
    setIsOpen: setIsOpen,
    ...
    rtl: rtl
  }), React__default.createElement(mask.Mask, {
    sizes: sizes,
  ...
  }), React__default.createElement(popover.Popover, {
    sizes: sizes,
    styles: styles,
    ...
    className: className
  }, showBadge ? React__default.createElement(Badge, {
    styles: styles
  }, badge) : null, showCloseButton ? React__default.createElement(Close, {
    styles: styles,
  ...
  }) : null, React__default.createElement(Content, {
...
var FocusManager = function FocusManager(_ref2) {
  var disabled = _ref2.disabled,
      children = _ref2.children;
  return disabled ? React__default.createElement(React__default.Fragment, null, children) : React__default.createElement(focus.FocusScope, {
    contain: true,
    autoFocus: true,
    restoreFocus: true
  }, children);
...
var TourContext = /*#__PURE__*/React__default.createContext(defaultState);
...
var TourProvider = function TourProvider(_ref) {
  ...
  var _useState2 = React.useState(startAt),
      currentStep = _useState2[0],
      setCurrentStep = _useState2[1];

  var _useState3 = React.useState(defaultSteps),
      steps = _useState3[0],
  ...
  return React__default.createElement(TourContext.Provider, {
    value: value
  }, children, isOpen ? React__default.createElement(Tour, Object.assign({}, value)) : null);
};
function useTour() {
...
function withTour(WrappedComponent) {
  var ComponentWithTour = function ComponentWithTour(props) {
    ...
    return React__default.createElement(WrappedComponent, Object.assign({}, props, tourProps));
  };
...
//# sourceMappingURL=tour.cjs.development.js.map
